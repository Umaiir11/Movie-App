            ...
            children: [
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Get.toNamed(AppRoutes.ticketView, arguments: {'name': movie.title});
                  },
  ...
  void initState() {
    ...
    _controller =
        YoutubePlayerController(
          ...
          flags: const YoutubePlayerFlags(autoPlay: true, mute: false, enableCaption: true, captionLanguage: 'en'),
        )..addListener(() {
